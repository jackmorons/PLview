...
- in tools page:
    ...
    ----- pattern discoverer, what makes a strong lifter? mostly scatter plots of various + relative lifts correlation, showing the correlation between the lifts in the same cathegory (scatter squat vs bench, squat vs deadlift, bench vs deadlift)
